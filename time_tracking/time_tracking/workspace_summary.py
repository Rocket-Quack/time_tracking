...
def get_workspace_summary():
	...
	weekly_total_minutes = _add_holiday_minutes(profile, week_start, week_end, weekly_total_minutes)
	monthly_total_minutes = _add_holiday_minutes(profile, month_start, month_end, monthly_total_minutes)
